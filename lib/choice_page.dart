...
class Choice {
  ...
  Choice({required this.buildingID, this.departmentName});

  Future<String> getImageUrl() async {
    String imageName = 'instrumentality';

    FirebaseFirestore.instance
        .collection("buildings")
        .doc(buildingID as String?)
        .get()
        .then((DocumentSnapshot documentSnapshot) {
      if (documentSnapshot.exists) {
        imageName = '${documentSnapshot.get("campus")}_$buildingID';
      } else {
        imageName;
...
final List<Choice> _choices = [Choice(buildingID: 0)];
